					...
					<div className="flex flex-col gap-8">
						...
						<div className="flex flex-col gap-6">
							<div className="flex flex-col gap-3">
								...
								<Input id="amount" value={amount} placeholder="₦" className="col-span-3" type="number" />
							</div>
							<div className="flex flex-col gap-3">
								<Label htmlFor="account-number" className="text-white font-NunitoSans">
									Account number
								</Label>
								<Input id="account-number" value="1000" placeholder="₦" className="col-span-3" type="number" />
							</div>
							<div className="flex flex-col gap-3">
							...
							<div className="flex flex-col gap-3">
								<Label htmlFor="account-name" className="text-white font-NunitoSans">
									Account Name
								</Label>
								<Input id="account-name" value="Joseph Keswet" placeholder="" className="col-span-3" type="text" />
							</div>
						</div>
						<div className="flex justify-end">
							<Button className="bg-[#E903E733] rounded-[100px] w-full md:w-[151px] h-[32px] uppercase text-xs text-white font-NunitoSans font-bold border border-[#F002EE]">
