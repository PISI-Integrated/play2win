...
type Props = {
  handlerFunc: () => void; // Function to open sign-up
  action: () => void; // Function to close modal after successful sign-in
  forgotPasswordFunc: () => void; // Function to open forgot password modal
};

const SignInContent = ({ handlerFunc, action, forgotPasswordFunc }: Props) => {
      ...
      <div className="grid gap-4 py-4">
        ...
        <div className="flex justify-end">
          <span
            ...
            className="text-[#FF00E5] text-sm font-semibold font-NunitoSans cursor-pointer"
          >
            Forgot Password?
          </span>
        </div>
